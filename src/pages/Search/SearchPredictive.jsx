...
const PredictiveSearch = ({ productData, setProductData, recommendations, setRecommendations, filteredRecommendations, setFilteredRecommendations }) => {
      ...
      <main-search>
        ...
        >
          <div className="field">
                      ...
                      {filteredRecommendations.map((item) => (
                        <li key={item.id} className="predictive-search__list-item">
                          <a href={`/collections/all/?category=${item.title}`} className="predictive-search__item link link--text">
                            ...
                            <div className="predictive-search__item-content predictive-search__item-content--centered" style={{paddingFeft: "20px"}}>
            ...
            <button
              type="submit"
              className="search__submit field__button"
              aria-label="Поиск"
            >
              <svg
